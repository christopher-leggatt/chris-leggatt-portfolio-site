...
// Renders a link that displays an image preview on hover.
...
const PopoverLink: React.FC<PopoverLinkProps> = ({ children, href }) => {
  ...
  const [popoverTransform, setPopoverTransform] = useState(""); // State to manage CSS transform value for popover position.
  let inImagePreview = false;
  let inLink = false;
  const plausible = usePlausible();

  const origin = // Dynamically determine the site's origin for API calls.
